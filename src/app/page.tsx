  ...
  return (
    <div className="flex min-h-screen flex-col bg-white text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100">
      ...
      <main className="flex-1">
        <section className="container py-12 md:py-24 lg:py-32">
          <div className="grid gap-6 lg:grid-cols-[1fr_600px] lg:gap-12 xl:grid-cols-[1fr_800px]">
            <div className="flex flex-col justify-center space-y-6">
              <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl text-zinc-900 dark:text-white">
              🚀 Ready for Launch — 
              <br />
        ...
        <section className="container py-12 md:py-24 border-t border-zinc-200 dark:border-zinc-800">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-zinc-900 dark:text-white mb-4">
              Generate Backend Code with AI
            </h2>
            <p className="text-zinc-600 dark:text-zinc-400 md:text-xl/relaxed max-w-3xl mx-auto">
