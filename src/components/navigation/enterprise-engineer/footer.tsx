...
const EnterpriseFooter = () => {
  ...
  return (
    <footer
      ...
      className="bg-cover bg-center bg-no-repeat px-3 py-[63px] text-neutral-400 lg:px-0"
    >
      <PaddingContainer>
        <div className="max:gap-16 mx-auto flex max-w-[1200px] flex-col gap-8">
          {/* Logo Section */}
          ...
          <div className="flex flex-col justify-between gap-8 lg:flex-row lg:gap-16">
            ...
            <div className="flex max-w-[296px] flex-col gap-[34px] max-sm:max-w-[200px]">
              <p className="text-md font-medium lg:text-display-xs">
                Ready to generate Backend?
              </p>
              <div className="flex flex-col gap-6">
                <Link
                  href="/create-backend"
                  className="rounded-lg border border-neutral-500 bg-primary py-3 text-center text-white hover:bg-neutral-600 hover:text-[#C0C0C1]"
                >
                  Generate Backend
                </Link>
                <Link
